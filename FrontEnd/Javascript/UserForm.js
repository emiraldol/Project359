...
async function CheckUsername() {
    ...
    const res = await fetch("http://localhost:3000/CheckUserNameUser?Username=" + username, {
        method: "GET",
        credentials: "include",
    });
    if (res.status === 200) {
        ...
        document.getElementById("usernameExists").textContent = "User with that Username exist in database Users";
    }
    else {
        checkUserName = true;
...
async function CheckEmail() {
    ...
    const res = await fetch("http://localhost:3000/CheckEmailUser?Email=" + email, {
        method: "GET",
        credentials: "include",
    });
    if (res.status === 200) {
        ...
        document.getElementById("emailExists").textContent = "User with that email exist in database Users";
    }
    else {
        checkemail = true;
...
async function CheckPhone() {
    ...
    const res = await fetch("http://localhost:3000/CheckPhoneUser?PhoneNumber=" + telephone, {
        method: "GET",
        credentials: "include",
    });
    if (res.status === 200) {
        ...
        document.getElementById("telephoneExist").textContent = "User with that telephone exist in database Users";
    }
    else {
...
function login() {
    ...
    document.getElementById("welcome").textContent = "Log In Application For Users";
